...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
 \hlstd{ghog.data}\hlopt{$}\hlstd{gr.daysbelow32} \hlkwb{<-} \hlkwd{ifelse}\hlstd{(ghog.data}\hlopt{$}\hlstd{daysbelow32}\hlopt{<}\hlkwd{mean}\hlstd{(ghog.data}\hlopt{$}\hlstd{daysbelow32),}
                               \hlstr{"Long Winter"}\hlstd{,}\hlstr{"Short Winter"}\hlstd{)}
 \hlstd{ghog.data}\hlopt{$}\hlstd{gr.daysbelow32} \hlkwb{<-} \hlkwd{as.factor}\hlstd{(ghog.data}\hlopt{$}\hlstd{gr.daysbelow32)}
...
\hlstd{ghog.data}\hlopt{$}\hlstd{ghog.correct} \hlkwb{<-} \hlkwd{ifelse}\hlstd{(ghog.data}\hlopt{$}\hlstd{gr.ghog.predict}\hlopt{==}\hlstd{ghog.data}\hlopt{$}\hlstd{gr.daysbelow32,}
